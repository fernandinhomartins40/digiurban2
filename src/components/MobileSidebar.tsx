...
export const MobileSidebar: FC = () => {
  ...
  return (
    <>
      ...
      {/* Backdrop */}
      <div
        className={`md:hidden fixed inset-0 z-40 bg-gray-600 bg-opacity-75 transform ${
      ...
      {/* Mobile sidebar */}
      <div
        className={`md:hidden fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        } transition-transform duration-300 ease-in-out flex flex-col h-full`}
      >
        {/* Fixed top section - Logo */}
        <div className="sticky top-0 bg-white dark:bg-gray-800 z-10 border-b border-gray-200 dark:border-gray-700 p-4 shadow-sm">
        ...
        {/* Scrollable middle section - Menus */}
        ...
        <div className="sticky bottom-0 bg-white dark:bg-gray-800 z-10 border-t border-gray-200 dark:border-gray-700 shadow-inner">
          <UserProfile />
        </div>
      </div>
    </>
