...
const MeusProtocolos: FC = () => {
  ...
  const handleAvaliarProtocolo = async (protocoloId: string) => {
    ...
    navigate(`/cidadao/protocolo/${protocoloId}/avaliar`);
  };

  const handleVerDetalhes = (protocoloId: string) => {
    navigate(`/cidadao/protocolo/${protocoloId}`);
  };

  const handleNovoProtocolo = () => {
    navigate('/cidadao/catalogo-servicos');
  };
                  ...
                  <CardHeader className="p-4 pb-0">
                    ...
                    >
                      <div className="flex items-center gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          <CardTitle className="text-lg">{protocolo.titulo}</CardTitle>
