-- =====================================================
-- 13_inserir_usuarios_teste_supabase_v2.sql
-- INSERIR USUÁRIOS DE TESTE DIRETAMENTE NO SUPABASE (VERSÃO CORRIGIDA)
-- =====================================================
...
-- =====================================================
-- PRIMEIRO: VERIFICAR ESTRUTURA DA TABELA auth.users
-- =====================================================

-- Executar primeiro para ver as colunas disponíveis:
-- SELECT column_name FROM information_schema.columns WHERE table_schema = 'auth' AND table_name = 'users';

-- =====================================================
-- INSERIR USUÁRIOS DE TESTE (VERSÃO SIMPLIFICADA)
-- =====================================================
...
BEGIN
    ...
    INSERT INTO auth.users (
        ...
        phone_change_sent_at, confirmed_at
    ) VALUES (
        ...
        null, null, null, 0, null, '', null, '', null, now()
    );
...
/*
🎯 COMO USAR ESTE SCRIPT CORRIGIDO:
...
⚠️ CORREÇÕES FEITAS:
- Removidas colunas inexistentes: email_confirmed, phone_confirmed_at, phone_confirmed
- Mantidas apenas colunas válidas da tabela auth.users
